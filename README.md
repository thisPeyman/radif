...
- `HCAPTCHA_SITE_KEY` و `HCAPTCHA_SECRET`: کلید عمومی و محرمانه hCaptcha برای محافظت از ورود و ارسال کد پیامک. هر دو در تولید الزامی‌اند؛ `DEV_OTP_CODE` فقط در توسعه محلی آن را دور می‌زند.
