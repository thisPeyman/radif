...
`SEED_ADMIN_NAME` اختیاری است. اجرای دوباره این فرمان رکورد تکراری ایجاد نمی‌کند و رمز همان مدیر را به‌روزرسانی می‌کند. فروشگاه و محصول باید جداگانه ساخته شوند.
