...
اطلاعات مشتری و یک تصویر رسید در یک مرحله ثبت می‌شوند. رسیدها خارج از فایل‌های عمومی و در مسیر `DATA_DIR/receipts` نگهداری می‌شوند؛ از این پوشه همراه پایگاه داده پشتیبان بگیرید.
