...
اطلاعات مشتری و یک تصویر رسید در یک مرحله ثبت می‌شوند. رسیدها در `DATA_DIR/receipts` و تصویرهای عمومی محصول در `DATA_DIR/product-images` نگهداری می‌شوند؛ از هر دو پوشه همراه PostgreSQL پشتیبان بگیرید.
