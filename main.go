...
func newServer(db *gorm.DB, cfg config) *echo.Echo {
	...
	e.POST("/api/shops/:shopID/products", createProduct(db, cfg), requireAdmin(db, cfg), requireShopOwner(db), origin)
	e.PATCH("/api/shops/:shopID/products/:productID", updateProduct(db, cfg), requireAdmin(db, cfg), requireShopOwner(db), origin)
	e.DELETE("/api/shops/:shopID/products/:productID", archiveProduct(db), requireAdmin(db, cfg), requireShopOwner(db), origin)
	e.POST("/api/shops/:shopID/products/:productID/activate", activateProduct(db), requireAdmin(db, cfg), requireShopOwner(db), origin)
